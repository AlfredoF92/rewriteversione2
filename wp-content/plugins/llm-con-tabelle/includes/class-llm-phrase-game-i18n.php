...
class LLM_Phrase_Game_I18n {
	...
	private static function bundles() {
		...
		$cache = array(
			...
			'mic_hint'              => 'Clicca per parlare (5 secondi)',
			'mic_pending'           => 'Avvio microfono…',
			'mic_listening'         => 'Sto ascoltando… (5 sec)',
		...
		'en' => array(
			...
			'mic_hint'              => 'Click to speak (5 seconds)',
			'mic_pending'           => 'Starting microphone…',
			'mic_listening'         => 'Listening… (5 sec)',
			'mic_grace'             => 'Finishing…',
		...
		'pl' => array(
			...
			'intro_label'           => 'Wstęp:',
			'mic_hint'              => 'Kliknij, aby mówić (5 sekund)',
			'mic_pending'           => 'Uruchamiam mikrofon…',
			'mic_listening'         => 'Słucham… (5 sek)',
		...
		'es' => array(
			...
			'mic_hint'              => 'Haz clic para hablar (5 segundos)',
			'mic_pending'           => 'Iniciando micrófono…',
			'mic_listening'         => 'Escuchando… (5 seg)',
