	...
	private static function bundles() {
		...
		$cache = array(
			'it' => array(
				...
				'rewrite_prompt'        => 'Ora scrivi o pronuncia correttamente la frase, aiutandoti con l\'ascolto:',
			...
			'mic_hint'              => 'Clicca per parlare (4 secondi)',
			'mic_pending'           => 'Avvio microfono…',
			'mic_listening'         => 'Sto ascoltando… (4 sec)',
		...
		'en' => array(
				...
				'rewrite_prompt'        => 'Now write or say the sentence correctly, using the audio to help you:',
			...
			'mic_hint'              => 'Click to speak (4 seconds)',
			'mic_pending'           => 'Starting microphone…',
			'mic_listening'         => 'Listening… (4 sec)',
			'mic_grace'             => 'Finishing…',
		...
		'pl' => array(
				...
				'rewrite_prompt'        => 'Teraz napisz lub wypowiedz zdanie poprawnie, korzystając z odsłuchu:',
			...
			'intro_label'           => 'Wstęp:',
			'mic_hint'              => 'Kliknij, aby mówić (4 sekundy)',
			'mic_pending'           => 'Uruchamiam mikrofon…',
			'mic_listening'         => 'Słucham… (4 sek)',
		...
		'es' => array(
				...
				'rewrite_prompt'        => 'Ahora escribe o di la frase correctamente, ayudándote con el audio:',
			...
			'mic_hint'              => 'Haz clic para hablar (4 segundos)',
			'mic_pending'           => 'Iniciando micrófono…',
			'mic_listening'         => 'Escuchando… (4 seg)',
