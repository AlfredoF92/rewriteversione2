	...
	private static function bundles() {
		...
		$cache = array(
			'it' => array(
				...
				'phase2_fail'           => 'La frase non è ancora abbastanza vicina al modello. Riprova.',
			...
			'en' => array(
				...
				'phase2_fail'           => 'The sentence is still not close enough to the model. Try again.',
			...
			'pl' => array(
				...
				'phase2_fail'           => 'Zdanie jest jeszcze zbyt mało podobne do wzoru. Spróbuj ponownie.',
			...
			'es' => array(
				...
				'phase2_fail'           => 'La frase aún no se parece lo suficiente al modelo. Inténtalo de nuevo.',
