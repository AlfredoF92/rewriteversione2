	...
	private static function bundles() {
		...
		$cache = array(
			'it' => array(
				...
				'login_error_generic'  => 'Username o password non corretti.',
				'login_error_empty'    => 'Inserisci username e password.',
				'login_already_in'     => 'Sei gia connesso.',
				'login_go_account'     => 'Vai all\'area personale',
				'settings_label'       => 'Impostazioni',
				'settings_restart'     => 'Ricomincia storia',
				'settings_restart_confirm' => 'Ricominciare dall\'inizio? Le frasi completate verranno azzerate (i coin guadagnati restano).',
				'settings_restarted'       => 'Storia riavviata. Ricarico...',
				'settings_accents_label'   => 'Considera gli accenti',
				'settings_accents_on'      => 'Attivo',
				'settings_accents_off'     => 'Disattivo',
			...
			'en' => array(
				...
				'login_error_empty'    => 'Enter username and password.',
				'login_already_in'     => 'You are already logged in.',
				'login_go_account'     => 'Go to your account',
				'settings_label'       => 'Settings',
				'settings_restart'     => 'Restart story',
				'settings_restart_confirm' => 'Restart from the beginning? Completed phrases will be reset (earned coins are kept).',
				'settings_restarted'       => 'Story restarted. Reloading...',
				'settings_accents_label'   => 'Consider accents',
				'settings_accents_on'      => 'On',
				'settings_accents_off'     => 'Off',
			...
			'pl' => array(
				...
				'login_remember'       => 'Zapamietaj mnie',
				'login_error_generic'  => 'Nieprawidlowa nazwa uzytkownika lub haslo.',
				'login_error_empty'    => 'Wpisz nazwe uzytkownika i haslo.',
				'login_already_in'     => 'Jestes juz zalogowany.',
				'login_go_account'     => 'Przejdz do konta',
				'settings_label'       => 'Ustawienia',
				'settings_restart'     => 'Zacznij od nowa',
				'settings_restart_confirm' => 'Zaczynac od poczatku? Ukonczone zdania zostana zresetowane (zdobyte monety pozostaja).',
				'settings_restarted'       => 'Historia zresetowana. Przeladowuję...',
				'settings_accents_label'   => 'Uwzgledniaj akcenty',
				'settings_accents_on'      => 'Wlaczone',
				'settings_accents_off'     => 'Wylaczone',
			...
			'es' => array(
				...
				'login_error_generic'  => 'Usuario o contrasena incorrectos.',
				'login_error_empty'    => 'Introduce usuario y contrasena.',
				'login_already_in'     => 'Ya has iniciado sesion.',
				'login_go_account'     => 'Ir a tu cuenta',
				'settings_label'       => 'Configuracion',
				'settings_restart'     => 'Reiniciar historia',
				'settings_restart_confirm' => 'Empezar desde el principio? Las frases completadas se reiniciaran (las monedas ganadas se mantienen).',
				'settings_restarted'       => 'Historia reiniciada. Recargando...',
				'settings_accents_label'   => 'Considerar acentos',
				'settings_accents_on'      => 'Activado',
				'settings_accents_off'     => 'Desactivado',
