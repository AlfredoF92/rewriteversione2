	...
	private static function bundles() {
		...
		$cache = array(
			'it' => array(
				...
				'resumed_account'  => 'Ripresa la partita salvata nel tuo account.',
				...
				'zoom_in'          => 'Ingrandisci il cruciverba',
				'zoom_out'         => 'Riduci il cruciverba',
				'solution_phrase'  => 'Soluzione Frase n. %d',
				'story_intro_title' => 'Mettiti alla prova',
				'story_intro_text'  => 'Ogni parola di questo cruciverba sta in una delle frasi che hai già studiato. Prenditi il tempo che ti serve — e in bocca al lupo.',
			),
			'en' => array(
				'across'           => 'Across',
				'down'             => 'Down',
				...
				'resumed_account'  => 'Resumed the game saved in your account.',
				...
				'zoom_in'          => 'Zoom in on the crossword',
				'zoom_out'         => 'Zoom out of the crossword',
				'solution_phrase'  => 'Soluzione Frase n. %d',
				'story_intro_title' => 'Test yourself',
				'story_intro_text'  => 'Every word in this crossword lives in a sentence you have already studied. Take your time — and good luck.',
			),
			'pl' => array(
				'across'           => 'Poziomo',
				'down'             => 'Pionowo',
				...
				'resumed_account'  => 'Wznowiono gre zapisana na twoim koncie.',
				...
				'keyboard'         => 'Klawiatura',
				'keyboard_backspace' => 'Backspace',
				'zoom_in'          => 'Powieksz krzyzowke',
				'zoom_out'         => 'Pomniejsz krzyzowke',
				'solution_phrase'  => 'Soluzione Frase n. %d',
				'story_intro_title' => 'Sprawdz sie',
				'story_intro_text'  => 'Kazde slowo w tej krzyzowce pochodzi ze zdania, ktore juz cwiczyles. Daj sobie czas — i powodzenia.',
			),
			'es' => array(
				'across'           => 'Horizontales',
				'down'             => 'Verticales',
				...
				'resumed_account'  => 'Retomada la partida guardada en tu cuenta.',
				...
				'zoom_in'          => 'Ampliar el crucigrama',
				'zoom_out'         => 'Reducir el crucigrama',
				'solution_phrase'  => 'Soluzione Frase n. %d',
				'story_intro_title' => 'Ponlo a prueba',
				'story_intro_text'  => 'Cada palabra de este crucigrama esta en una frase que ya has estudiado. Tomate tu tiempo — y suerte.',
			),
		);
